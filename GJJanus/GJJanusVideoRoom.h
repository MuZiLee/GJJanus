...
- (void)GJJanusVideoRoom:(GJJanusVideoRoom *_Nullable)plugin didJoinRoomWithID:(NSUInteger)clientID;

- (void)GJJanusVideoRoom:(GJJanusVideoRoom *_Nullable)p_Nullablelugin didJoinRoomWithID:(NSUInteger)clientID;
- (void)GJJanusVideoRoomDidLeaveRoom:(GJJanusVideoRoom *_Nullable)plugin;
- (void)GJJanusVideoRoom:(GJJanusVideoRoom *_Nullable)plugin newRemoteJoinWithID:(NSUInteger)clientID;
- (void)GJJanusVideoRoom:(GJJanusVideoRoom *_Nullable)plugin remoteLeaveWithID:(NSUInteger)clientID;

- (void)GJJanusVideoRoom:(GJJanusVideoRoom *_Nullable)plugin firstFrameDecodeWithSize:(CGSize)size uid:(NSUInteger)uid;
- (void)GJJanusVideoRoom:(GJJanusVideoRoom *_Nullable)plugin renderSizeChangeWithSize:(CGSize)size uid:(NSUInteger)uid;

- (void)GJJanusVideoRoom:(GJJanusVideoRoom *_Nullable)plugin fatalErrorWithID:(KKRTCErrorCode)errorCode;
- (void)GJJanusVideoRoom:(GJJanusVideoRoom *_Nullable)plugin netBrokenWithID:(KKRTCNetBrokenReason)reason;
...
//- (instanc _Nullable etype)initWithServer:(NSURL  *_Nullable)server delegate:(id<GJJanusVideoRoomDelegate>)delegate;
...
- (void)joinRoomWithRoomID:(NSInteger)roomID userName:(NSString *_Nullable)userName completeCallback:(CompleteCallback _Nullable )callback;
- (void)leaveRoom:(void(^_Nullable )(void))leaveBlock;
- (BOOL)startPrewViewWithCanvas:(KKRTCCanvas *_Nullable)canvas;
- (KKRTCCanvas *_Nullable)stopPrewViewWithUid:(NSUInteger)uid;
