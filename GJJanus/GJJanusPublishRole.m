...
-(RTCVideoSource *)videoSource{
    if (_videoSource == nil) {
        _videoSource = [[RTCFactory shareFactory].factory videoSource];
    }
    return _videoSource;
}
...
-(RTCAudioSource*)audioSource{
    if (_audioSource == nil) {
        _audioSource = [[RTCFactory shareFactory].factory audioSourceWithConstraints:[self.mediaConstraints getAudioConstraints]];
    }
    return _audioSource;
}
- (RTCRtpSender *)createAudioSender {
    RTCAudioSource *source = self.audioSource;
    RTCAudioTrack *track = [[RTCFactory shareFactory].factory audioTrackWithSource:source
...
- (RTCRtpSender *)createVideoSender {
    ...
    RTCVideoTrack* localVideoTrack = [[RTCFactory shareFactory].factory videoTrackWithSource:self.videoSource trackId:kARDVideoTrackId];
